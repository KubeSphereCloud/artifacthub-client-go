...
// WithOrgName adds the orgName to the add organization member params
func (o *AddOrganizationMemberParams) WithOrgName(orgName string) *AddOrganizationMemberParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the add organization member params
func (o *AddOrganizationMemberParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}

// WithUserAlias adds the userAlias to the add organization member params
func (o *AddOrganizationMemberParams) WithUserAlias(userAlias string) *AddOrganizationMemberParams {
	o.SetUserAlias(userAlias)
	return o
}

// SetUserAlias adds the userAlias to the add organization member params
func (o *AddOrganizationMemberParams) SetUserAlias(userAlias string) {
