...
// WithContentType adds the contentType to the register user params
func (o *RegisterUserParams) WithContentType(contentType *string) *RegisterUserParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the register user params
func (o *RegisterUserParams) SetContentType(contentType *string) {
	o.ContentType = contentType
}

// WithBody adds the body to the register user params
func (o *RegisterUserParams) WithBody(body *models.UsersRequest) *RegisterUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the register user params
func (o *RegisterUserParams) SetBody(body *models.UsersRequest) {
	o.Body = body
}
