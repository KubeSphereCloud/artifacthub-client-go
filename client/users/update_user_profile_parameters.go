...
// WithContentType adds the contentType to the update user profile params
func (o *UpdateUserProfileParams) WithContentType(contentType *string) *UpdateUserProfileParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the update user profile params
func (o *UpdateUserProfileParams) SetContentType(contentType *string) {
	o.ContentType = contentType
}

// WithBody adds the body to the update user profile params
func (o *UpdateUserProfileParams) WithBody(body *models.User) *UpdateUserProfileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user profile params
func (o *UpdateUserProfileParams) SetBody(body *models.User) {
	o.Body = body
}
