...
type ResetPasswordParams struct {
	...
	// Body.
	Body *models.UsersResetPasswordRequest
...
// WithContentType adds the contentType to the reset password params
func (o *ResetPasswordParams) WithContentType(contentType *string) *ResetPasswordParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the reset password params
func (o *ResetPasswordParams) SetContentType(contentType *string) {
	o.ContentType = contentType
}

// WithBody adds the body to the reset password params
func (o *ResetPasswordParams) WithBody(body *models.UsersResetPasswordRequest) *ResetPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the reset password params
func (o *ResetPasswordParams) SetBody(body *models.UsersResetPasswordRequest) {
	o.Body = body
}
