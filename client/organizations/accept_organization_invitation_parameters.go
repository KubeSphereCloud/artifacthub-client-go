...
// WithOrgName adds the orgName to the accept organization invitation params
func (o *AcceptOrganizationInvitationParams) WithOrgName(orgName string) *AcceptOrganizationInvitationParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the accept organization invitation params
func (o *AcceptOrganizationInvitationParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
