...
// WithContentType adds the contentType to the add organization params
func (o *AddOrganizationParams) WithContentType(contentType *string) *AddOrganizationParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the add organization params
func (o *AddOrganizationParams) SetContentType(contentType *string) {
	o.ContentType = contentType
}

// WithBody adds the body to the add organization params
func (o *AddOrganizationParams) WithBody(body *models.OrganizationSummary) *AddOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add organization params
func (o *AddOrganizationParams) SetBody(body *models.OrganizationSummary) {
	o.Body = body
}
