...
type UpdateUserPasswordParams struct {
	...
	// Body.
	Body *models.UsersPasswordRequest
...
// WithContentType adds the contentType to the update user password params
func (o *UpdateUserPasswordParams) WithContentType(contentType *string) *UpdateUserPasswordParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the update user password params
func (o *UpdateUserPasswordParams) SetContentType(contentType *string) {
	o.ContentType = contentType
}

// WithBody adds the body to the update user password params
func (o *UpdateUserPasswordParams) WithBody(body *models.UsersPasswordRequest) *UpdateUserPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user password params
func (o *UpdateUserPasswordParams) SetBody(body *models.UsersPasswordRequest) {
	o.Body = body
}
