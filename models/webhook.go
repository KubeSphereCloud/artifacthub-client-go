...
type Webhook struct {
	...
	// Required: true
	// Format: uuid
	WebhookID *strfmt.UUID `json:"webhook_id"`
}
...
func (m *Webhook) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateLastNotifications(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Webhook) validateActive(formats strfmt.Registry) error {
...
func (m *Webhook) validateEventKinds(formats strfmt.Registry) error {
...
func (m *Webhook) validateLastNotifications(formats strfmt.Registry) error {

	if err := validate.Required("last_notifications", "body", m.LastNotifications); err != nil {
		return err
	}

	for i := 0; i < len(m.LastNotifications); i++ {
		if swag.IsZero(m.LastNotifications[i]) { // not required
			continue
		}

		if m.LastNotifications[i] != nil {
			if err := m.LastNotifications[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("last_notifications" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("last_notifications" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *Webhook) validatePackages(formats strfmt.Registry) error {
...
func (m *Webhook) validateWebhookID(formats strfmt.Registry) error {
	...
	if err := validate.Required("webhook_id", "body", m.WebhookID); err != nil {
		return err
	}

	if err := validate.FormatOf("webhook_id", "body", "uuid", m.WebhookID.String(), formats); err != nil {
		return err
	}
...
func (m *Webhook) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateLastNotifications(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Webhook) contextValidateEventKinds(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Webhook) contextValidateLastNotifications(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.LastNotifications); i++ {

		if m.LastNotifications[i] != nil {
			if err := m.LastNotifications[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("last_notifications" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("last_notifications" + "." + strconv.Itoa(i))
...
func (m *Webhook) contextValidatePackages(ctx context.Context, formats strfmt.Registry) error {
